(function () {
    ...
    // Inject our constants RC and if needed, T that contain data from the server
    UserController.$inject = ['userService', '$mdSidenav', '$mdBottomSheet', '$log', 'RC'];

    /**
     * Main Controller for the Angular Material Starter App
     * @constructor
     */
    function UserController(userService, $mdSidenav, $mdBottomSheet, $log, RC) {
        var self = this;
